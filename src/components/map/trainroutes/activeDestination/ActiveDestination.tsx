            ...
            {isVisible && (
                <motion.g
                    ...
                    initial={{
                        opacity: 0,
                        scale: 0,
                        x: item.x - 1 / strokeScale,
                        y: item.y - 1 / strokeScale,
                    }}
                    animate={{
                        opacity: 1,
                        scale: 1 / strokeScale,
                        x: item.x - 15 / strokeScale,
                        y: item.y - 36 / strokeScale,
                    }}
                    exit={{
                        opacity: 0,
                        scale: 0,
                ...
                >
                    ...
                    <polygon
                        ...
                        points="2.2,0 2.2,25.4 11,25.4 15,29.6 19,25.4 27.8,25.4 27.8,0"
                    />
                    <rect
                        x="5.5"
                        y="3.2"
                    ...
                    <path
                        fill="white"
                        d="M19.7,7c-0.3-0.3-1.9-1.4-4.7-1.4S10.6,6.7,10.3,7S9.9,7.6,9.9,8v7.3c0,0.4,0.2,0.7,0.4,1s0.6,0.4,1,0.4h7.3
                ...
                C19,7.7,19.1,7.9,19.1,8V11.1z"
                    ...
                    <polygon
                        fill="white"
                        points="11.5,19.2 12.5,19.2 13.5,17.3 12.5,17.3 	"
                    />
                    <polygon
                        fill="white"
                        points="16.5,17.3 17.5,19.2 18.5,19.2 17.5,17.3 	"
                    />
                </motion.g>
            )}
        </AnimatePresence>
